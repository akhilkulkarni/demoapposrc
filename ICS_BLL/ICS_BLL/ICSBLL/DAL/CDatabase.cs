...
// References : System.configuration,System.Web
////
...
namespace DataAccessLayer
{
    public class CDatabase
    {
        ...
        //       ds_status.ReadXml(@"C:\DenosftWebVer6.0\DensoftSetup\TempData\Setting" + strPath + ".XML");
        ...
        public static SqlConnection getConnection()
        {
            ...
            strMasterCon = strMasterCon + ";persist security info=False";
            strMasterCon = strMasterCon + ";initial catalog=" + strDBName;
            strMasterCon = "Data Source=INFOCASIER-PC;Initial Catalog=DEN;Integrated Security=True";
            return new SqlConnection(strMasterCon);
        }
        ...
        public static string GetConnectionString()
        {
            ...
            //strLocation = ConfigurationManager.AppSettings["ProjectLocation"].ToString();
            ...
            //    if (strLocation.Trim().ToLower() == "ida")
            //    {
            //        if (name.Trim().ToLower() == "conn_ida")
            //        {
            ...
            //return "User ID=sa;password=idawebsite;data source=Servernew\\MSSQLSERVER1;persist security info=False;initial catalog=Densoft_Newer; Connect Timeout=50000;pooling='true'; Max Pool Size=200 ";
